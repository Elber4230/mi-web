...
const renderBands = () => {
  ...
  bands.forEach((frequency, index) => {
    ...
    slider.addEventListener("input", (event) => {
      ...
      if (state.filters[index]) state.filters[index].gain.value = value;
    });
...
audioElement.addEventListener("pause", () => updateStatus("Pausado."));
audioElement.addEventListener("ended", () => updateStatus("Finalizó la reproducción."));
